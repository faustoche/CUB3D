...
/*   Updated: 2025/05/21 22:21:56 by faustoche        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_textures_north(t_mlx *mlx)
{
	...
	mlx->game->north_texture.img = mlx_xpm_file_to_image(mlx->game->mlx_ptr, mlx->game->meta.no, &width, &height);
...
int	load_textures_south(t_mlx *mlx)
{
	...
	mlx->game->south_texture.img = mlx_xpm_file_to_image(mlx->game->mlx_ptr, mlx->game->meta.so, &width, &height);
...
int	load_textures_east(t_mlx *mlx)
{
	...
	mlx->game->east_texture.img = mlx_xpm_file_to_image(mlx->game->mlx_ptr, mlx->game->meta.ea, &width, &height);
...
int	load_textures_west(t_mlx *mlx)
{
	...
	mlx->game->west_texture.img = mlx_xpm_file_to_image(mlx->game->mlx_ptr, mlx->game->meta.we, &width, &height);
